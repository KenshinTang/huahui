                ...
                value: function() {
                    ...
                    (0, f.addEvent)(this.pickerEl, "touchmove", function(e) {
                        ...
                        for (var t = !1, i = 0; i < e.data.length; i++) {
                            ...
                            e.selectedIndex[i] = n;
                            var r = null;
                            (e.data[i] && e.data[i].length) && (r = e.data[i][n].value), e.selectedVal[i] !== r && (t = !0), e.selectedVal[i] = r
                        }
...
function Commpicker(title, data, cb) {
...
function Areapicker(title, cb) {
    ...
    this.instance.on('picker.change', function(index) {
        if (index != 2) {
            var s = Area.getPickerData(this.selectedIndex[0], this.selectedIndex[1]);
...
//时间选择器
function Datepicker(title, cb, o) {
    var years = [];
    !o && (o = {});
    if (o.fromnow) {
    ...
    */
    ...
    for (var y = 0; y < years.length; y++) {
        if (now.getFullYear() == years[y].text) {
            iy = y;
        }
    }
    var nowm = now.getMonth() + 1;
    var nowmtext = nowm < 10 ? "0" + nowm : nowm;
    var im = 0;
    ...
    this.instance.on('picker.select', function() {
        ...
        cb && cb(obj, names.join(o.saperate != null ? o.saperate : "-"), sid);
    });

    this.instance.on('picker.change', function(index) {
        var y = this.data[0][this.selectedIndex[0]];
        var a = this.data[1][this.selectedIndex[1]];
        if (index === 0) {
            if (o.fromnow)
                this.refillColumn(1, getMonth(this.selectedIndex[0] === 0));
            this.scrollColumn(1, 0);

            if (this.data.length > 2) {
                this.refillColumn(2, getDay(1, y.text));
                this.scrollColumn(2, 0);
            }
        } else if (index === 1 && this.data.length > 2) {
            this.refillColumn(2, getDay(a.text, y.text));
            this.scrollColumn(2, 0);
        }
    });
...
function DatafullTime(title, cb, o) {
    var years = [];
    !o && (o = {});
    if (o.fromnow) {
        var y = new Date().getFullYear();
    ...
    */
    ...
    if (o.noday)
        ...
        data = [years, months, days, hh, mm, ss];


    this.instance = new Picker({
        title: title,
        data: data,
        selectedIndex: [iy, im, iday, ihh, imm, iss]
    });
    ...
    this.instance.on('picker.select', function() {
        ...
        for (var i = 0; i < names.length; i++) {
            if (i < 2) {
                ...
                if (i == names.length - 1) _str += names[i];
                else _str += names[i] + ':'
    ...
    DatafullTime.prototype.show = function() {
        this.instance.show();
    };
...
Commpicker.prototype.instance = Areapicker.prototype.instance = Datepicker.prototype.instance = null;
Commpicker.prototype.show = Areapicker.prototype.show = Datepicker.prototype.show = function() {
    this.instance.show();
};