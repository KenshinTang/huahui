...
public class WifiParameterConfigDialog {
    ...
    public void show(){
        ...
        final String ip = sharedPreferencesUtil.getString(com.yunlinker.printting.Constant.WIFI_DEFAULT_IP, com.yunlinker.printting.Constant.WIFI_CONFIG_IP);
        final String port = String.valueOf(sharedPreferencesUtil.getInt(com.yunlinker.printting.Constant.WIFI_DEFAULT_PORT, com.yunlinker.printting.Constant.WIFI_CONFIG_PORT));
                ...
                .setNegativeButton(mContext.getString(R.string.str_confirm), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!TextUtils.isEmpty(strIp) && !TextUtils.isEmpty(strPort)) {
                            if (!strIp.equals(ip)) {
                                sharedPreferencesUtil.putString(strIp, com.yunlinker.printting.Constant.WIFI_CONFIG_IP);
                            }
                            if (!strPort.equals(port)) {
                                sharedPreferencesUtil.putInt(Integer.parseInt(strPort), com.yunlinker.printting.Constant.WIFI_CONFIG_PORT);
                            }
